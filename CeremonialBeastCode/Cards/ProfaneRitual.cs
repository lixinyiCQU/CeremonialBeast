...
public sealed class ProfaneRitual : CeremonialBeastCard
{
    // ==========================================
    // 💡 终极优化：自我豁免声明！
    // ==========================================
    ...
    protected override async Task OnPlayCard(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        // 挂载亵渎仪式状态（标记型 Power）
        await PowerCmd.Apply<ProfaneRitualPower>(base.Owner.Creature, 1m, base.Owner.Creature, this);
    }
