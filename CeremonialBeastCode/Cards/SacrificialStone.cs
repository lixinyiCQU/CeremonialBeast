...
// 💡 优化 1：添加 sealed 关键字
public sealed class SacrificialStone() : CeremonialBeastCard(0, CardType.Skill, CardRarity.Token, TargetType.Self)
{
    ...
    public static async Task<IEnumerable<CardModel>> CreateInHand(Player owner, int count, ICombatState combatState, bool upgraded = false)
    {
        ...
        {
            CardModel newCard = combatState.CreateCard<SacrificialStone>(owner);
